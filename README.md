...
3. Download and install the [Monday.com JDBC Driver from CData](https://www.cdata.com/drivers/monday/download/jdbc)* and copy the JAR file to the /jars/3rdparty/ directory of your Dremio installation. For example:
