...
@SourceType(value = "MondayARP", label = "Monday",uiConfig = "monday-layout.json")
public class MondayConf extends AbstractArpConf<MondayConf> {
  private static final String ARP_FILENAME = "arp/implementation/monday-arp.yaml";
  private static final ArpDialect ARP_DIALECT =
      AbstractArpConf.loadArpFile(ARP_FILENAME, (ArpDialect::new));
  private static final String DRIVER = "cdata.jdbc.monday.MondayDriver";
